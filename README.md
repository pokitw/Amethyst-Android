...
* **A reachable game area** for large phones: draw the game, HUD included, into part of the screen
  instead of all of it, anchored wherever you can see it. Your controls stay where you put them.
  Fewer pixels, so it runs faster too
