...
public class LauncherPreferences {
    ...
    /** "system", "bundled", or "imported:" plus a folder under TurnipDrivers.root. */
    public static String PREF_TURNIP_DRIVER = "bundled";
    ...
    public static void loadPreferences(Context ctx) {
        ...
        // The old boolean folds into the driver choice: someone who preferred the system driver
        // keeps preferring it, read once so the new setting owns the answer from here on.
        PREF_TURNIP_DRIVER = DEFAULT_PREF.getString("turnipDriver",
                PREF_ZINK_PREFER_SYSTEM_DRIVER ? "system" : "bundled");
